...
public class GoalController {
    ...
    @GetMapping
    @Operation(summary = "Listagem de todas as metas", description = "Essa função é responsável por listar todos as metas")
    @ApiResponses({
    ...
    public ResponseEntity<List<GoalResponseDTO>> getAllGoals(@RequestParam int page , @RequestParam int size) {
        var result = this.goalService.getAllGoals(page, size);
    ...
    public ResponseEntity<GoalResponseDTO> updateGoalStatus( @PathVariable UUID id, @RequestBody GoalRequestUpdateDTO goalRequestUpdateDTO) {
