...
public class UserRequestDTO {
    ...
    @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "Foto do Usuário (URL opcional)")
    private String userPhoto;

    @NotBlank(message = "O nome é obrigatório")
    @Length(min = 2, max = 100, message = "O nome deve ter entre 2 e 100 caracteres")
    @Schema(example = "Thiago", requiredMode = Schema.RequiredMode.REQUIRED, description = "Nome do Usuário")
    private String name;

    @NotBlank(message = "O e-mail é obrigatório")
    @Email(message = "Insira um e-mail válido")
    @Schema(example = "example@mail.com", requiredMode = Schema.RequiredMode.REQUIRED, description = "E-mail do Usuário")
    private String email;

    @NotBlank(message = "O telefone é obrigatório")
    @Pattern(regexp = "\\(\\d{2}\\) \\d{5}-\\d{4}", message = "Telefone deve estar no formato (11) 99999-9999")
    @Schema(example = "(11) 99999-9999", requiredMode = Schema.RequiredMode.REQUIRED, description = "Telefone do Usuário")
    ...
    @Schema(requiredMode = Schema.RequiredMode.REQUIRED, description = "Senha do Usuário")
